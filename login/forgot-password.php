...
<head>
    ...
    <title>:: FOODCHILL :: QUÊN MẬT KHẨU</title>
    <!-- Favicon-->
                ...
                <div class="col-lg-4 col-sm-12">
                    <form class="card auth_form">
                        ...
                        <div class="body">
                            ...
                            <a href="index.html" class="btn btn-primary btn-block waves-effect waves-light">XÁC NHẬN</a>
                            <div class="signin_with mt-3">
                                <a href="javascript:void(0);" class="link">Cần trợ giúp?</a>
                            </div>
                        </div>
                    </form>
