                        ...
                        <tr id="product-tr<?= $product_id ?>" class="text-gray-700 dark:text-gray-400">
                            ...
                            <td class="px-1 py-3">
                                <div class="flex items-center space-x-4 text-sm">
                                    ...
                                    <a href="javascript:void(0)" data-product_id="<?= $product_id ?>" class="delete-product flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray" aria-label="Delete">
                                        <!-- Xóa     -->
                                        <svg class="w-5 h-5" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20">
